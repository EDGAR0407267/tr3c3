...
export const breadcrumbLabels: Record<Language, { home: string; menu: string; contact: string }> = {
  es: { home: "Inicio", menu: "Carta", contact: "Contacto y ubicación" },
  ca: { home: "Inici", menu: "Carta", contact: "Contacte i ubicació" },
  en: { home: "Home", menu: "Menu", contact: "Contact and location" },
  fr: { home: "Accueil", menu: "Carte", contact: "Contact et adresse" },
  de: { home: "Start", menu: "Karte", contact: "Kontakt und Adresse" },
  zh: { home: "首页", menu: "菜单", contact: "联系与地址" },
  nl: { home: "Home", menu: "Menu", contact: "Contact en locatie" },
  it: { home: "Home", menu: "Menu", contact: "Contatti e posizione" },
};
